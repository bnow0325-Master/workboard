...
test -f "${SOURCE_DIR}/favicon-bnow.png"
test -f "${SOURCE_DIR}/government/index.html"
test -f "${SOURCE_DIR}/vendor/supabase-js.min.js"
test -f "${SOURCE_DIR}/main.bnow.co.kr.conf"
test ! -e "${RELEASE_DIR}"

mkdir -p "${RELEASE_DIR}"
cp -a "${SOURCE_DIR}/index.html" "${RELEASE_DIR}/index.html"
cp -a "${SOURCE_DIR}/favicon-bnow.png" "${RELEASE_DIR}/favicon-bnow.png"
cp -a "${SOURCE_DIR}/government" "${RELEASE_DIR}/government"
cp -a "${SOURCE_DIR}/vendor" "${RELEASE_DIR}/vendor"
